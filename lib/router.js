...
Router.map(function () {
    ...
    // conventional input parameter guide
    this.route('conventionalInputParameterGuide', { "path": '/manual/conventional/input_guide'});
    this.route('broadbandInputParameterGuide', { "path": '/manual/broadband/input_guide'});

    // ctp website guide
    this.route('ctpWebsiteFaqs', { "path": '/manual/ctp_web/faqs'});
    this.route('ctuGuide', { "path": '/manual/ctp_web/ctu_guide'});
    ...
    // Admin promotion
    this.route('adminManager', {
        "path": '/adminManager',              
    });

    // Server routes
    this.route('getAllModemsInJson', {
        where: 'server',
        path: '/modemsAsJson',
        action: function() {

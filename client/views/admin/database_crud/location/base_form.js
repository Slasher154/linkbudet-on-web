...
Template.locationBaseForm.rendered = function(){


}

Template.locationBaseForm.showType = function(type){
    if(type == 'uplink'){
        return 'G/T';
    }
...
Template.locationDataBaseForm.satellites = function(){
...
Template.locationDataBaseForm.beams = function(){
...
Template.locationDataBaseForm.types = function(){
    return [
        {
            text: 'EIRP',
            value: 'downlink'
